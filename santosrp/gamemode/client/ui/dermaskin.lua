...
SKIN.PrintName 		= "SantosR{} Derma Skin"
SKIN.Author 		= "Lennart Bernhardt (Lenny. U:1:60844206)"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/santosrp.png" )
...
derma.DefineSkin( "SantosRP", "Awesome looking skin for SantosRP", SKIN )